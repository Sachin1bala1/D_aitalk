...
import { Table, ChevronRight, ChevronDown, Columns, Key, Search, X, Database, Power, ExternalLink, Layers, Hash, FolderOpen, Clock, BarChart2, Eye, Braces, Cog, Sigma } from "lucide-react";
  ...
  return (
    <>
      ...
      <div className="space-y-0.5 py-1">
        {filtered.map(([tableName, columns]) => {
          const isFocused =
            focusedNode != null &&
          ...
          return (
            <div key={tableName} className="group" ref={isFocused ? focusedRef : null}>
              <div
